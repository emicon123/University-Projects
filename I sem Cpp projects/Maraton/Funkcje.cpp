...
bool czytajDane(string nazwaPliku, maratonczyk *& pMaratonczyk)
{
	...
	getline(plikProtokolu, nazwaMaratonu);	//Pobranie pierwszej linii pliku - nazwy maratonu
	getline(plikProtokolu, data);			//Pobranie drugiej linii pliku - daty odbycia maratonu
	...
	*/
	...
	{
		while (plikProtokolu >> miejsce >> nazwisko >> nrMaratonczyka >> czas)
		{
...
{
	string nrAlbumuString = pMaratonczyk->nazwisko + ".txt";	//wyciagmy nazwisko maratonczyka, aby moc utworzyc plik wynikowy o nazwie takiej samej jak jego nazwisko
